...
public class WorkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        work.add(new ContactModel("raju","raju@gmail.com","+918825951346",R.drawable.contact));
        ...
        work.add(new ContactModel("rajesh","rajesh@gmail.com","+918815282546",R.drawable.contact));
